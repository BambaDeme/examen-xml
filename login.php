                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <p class="forgot-pass mb-0"><a href="auth-re-password.html" class="text-dark font-weight-bold">mot de passe oublié ?</a></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 text-center">
                                            <p class="mb-0 mt-3"><small class="text-dark mr-2">Vous n'avez pas de compte ?</small> <a href="auth-signup.php" class="text-dark font-weight-bold">Créer un compte</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
